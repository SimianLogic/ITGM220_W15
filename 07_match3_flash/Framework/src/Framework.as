package
{
	...
	public class Framework extends Sprite
	{
		...
		[Embed(source="jewel3.png")] public var jewel3_png:Class;
		...
		public var LIVE_EXAMPLE:int = SPRITE_EXAMPLE;
		...
		//SPRITE EXAMPLES
		public var bitmapExample:Bitmap;
		...
		{						
			bitmapExample = new jewel3_png();
			
			addChild(bitmapExample);			
			bitmapExample.x = 50;
			bitmapExample.y = 50;
		}
